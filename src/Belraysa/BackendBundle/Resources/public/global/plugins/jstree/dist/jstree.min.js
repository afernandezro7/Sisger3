...
(function (e) {
    ...
    "use strict";
    if (!e.jstree) {
        var i = 0, s = !1, r = !1, n = !1, a = [], d = e("script:last").attr("src"), o = document, c = o.createElement("LI"), l, h;
        c.setAttribute("role", "treeitem"), l = o.createElement("I"), l.className = "jstree-icon jstree-ocl", c.appendChild(l), l = o.createElement("A"), l.className = "jstree-anchor", l.setAttribute("href", "#"), h = o.createElement("I"), h.className = "jstree-icon jstree-themeicon", l.appendChild(h), c.appendChild(l), l = h = null, e.jstree = {
            ...
            plugin: function (t, i) {
                ...
                var r = i.is("ul") ? i.children() : i, n = t.id, a = [], d = [], o = this._model.data, c = o[n], l = this._data.core.selected.length, h, _, u;
                ...
                var n = null, a = {
                    ...
                    e.data && (e = e.data);
                    var i = e.dat, s = e.par, r = [], n = [], a = [], d = e.df, o = e.t_id, c = e.t_cnt, l = e.m, h = l[s], _ = e.sel, u, g, f, p, m = function (e, i, s) {
                ...
                var e = this._model.force_full_redraw ? this._model.data["#"].children.concat([]) : this._model.changed.concat([]), t = document.createElement("UL"), i, s, r, n = this._data.core.focused;
                ...
                var r = this.get_node(t), n = !1, a = !1, d = !1, o = !1, l = !1, h = !1, _ = "", u = document, g = this._model.data, f = !1, p = !1, m = null;
                if (!r)return !1;
                ...
                if (this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent))if (i.shiftKey) {
                    var s = this.get_node(e).id, r = this._data.core.last_clicked.id, n = this.get_node(this._data.core.last_clicked.parent).children, a = !1, d, o;
                ...
                var r = this._data.core.rtl, n = this.element.width(), a = i.children(".jstree-anchor"), d = e("<span>"), o = s, c = e("<div />", {
                    css: {
                        position: "absolute",
                        top: "-200px",
                        left: r ? "0px" : "-1000px",
        ...
        _.className = "jstree-icon jstree-checkbox", e.jstree.defaults.checkbox = {
            ...
            this.bind = function () {
                s.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", e.proxy(function () {
                    ...
                    var s = this._model.data, r = s[i.parent], n = i.nodes, a = [], d, o, c, l, h, _, u = this.settings.checkbox.cascade, g = this.settings.checkbox.tie_selection;
                    ...
                    var s = i.node, r = this._model.data, n = this.get_node(s.parent), a = this.get_node(s, !0), d, o, c, l, h = this.settings.checkbox.cascade, _ = this.settings.checkbox.tie_selection;
                    ...
                    var s = i.node, r = this.get_node(s, !0), n, a, d, o = this.settings.checkbox.cascade, c = this.settings.checkbox.tie_selection;
                    ...
                    var i = this.get_node(t.parent), s = this._model.data, r, n, a, d, o = this.settings.checkbox.tie_selection;
                    while (i && "#" !== i.id) {
                    ...
                    var s = i.is_multi, r = i.old_parent, n = this.get_node(i.parent), a = this._model.data, d, o, c, l, h, _ = this.settings.checkbox.tie_selection;
                    if (!s) {
                        d = this.get_node(r);
                        while (d && "#" !== d.id) {
                ...
                var t, i, s = this._model.data, r = this.settings.checkbox.tie_selection, n = this._data[r ? "core" : "checkbox"].selected, a = [], d = this;
                ...
                t = this.get_node(t);
                var i = this.settings.checkbox.cascade, s, r, n = this.settings.checkbox.tie_selection, a = this._data[n ? "core" : "checkbox"].selected, d = this._model.data;
            ...
            e.vakata.context = {
                settings: {hide_onmouseleave: 0, icons: !0}, _trigger: function (t) {
                    ...
                    if (t = e(t), t.length && t.children("ul").length) {
                        var s = t.children("ul"), r = t.offset().left + t.outerWidth(), n = t.offset().top, a = s.width(), d = s.height(), o = e(window).width() + e(window).scrollLeft(), c = e(window).height() + e(window).scrollTop();
            ...
            e(document).on("dnd_start.vakata.jstree", function (e, t) {
                ...
                if (r && clearTimeout(r), d && d.data && d.data.jstree && (!d.event.target.id || "jstree-marker" !== d.event.target.id)) {
                    var o = e.jstree.reference(d.event.target), c = !1, l = !1, h = !1, _, u, g, f, p, m, v, j, k, y, x, b, w, C;
        ...
        e.jstree.defaults.state = {
            ...
            this.init = function (e, i) {
                ...
                var n, a, d = this._model.data, o = i ? e.extend(!0, {}, i, {no_id: !1}) : {}, c = s.get_json.call(this, t, o, r);
                if (c === !1)return !1;
