...
!function (a) {
    ...
    function f(d, e, f) {
        function g(a, b, c) {
            ...
            do {
                if (a === !0 && n().validPositions[h]) {
                    ...
                    e = i.match, d = i.locator.slice(), g.push(c === !0 ? i.input : H(h, e))
                } else {
                    if (b > h) {
                        var j = v(h, d, h - 1);
                        f = j[0]
        ...
        function p(a) {
            var b = n(), c = -1, d = b.validPositions;
            void 0 == a && (a = -1);
            var e = c, f = c;
            for (var g in d) {
                var h = parseInt(g);
        ...
        function q(b, c, d) {
            if (f.insertMode && void 0 != n().validPositions[b] && void 0 == d) {
                var e, g = a.extend(!0, {}, n().validPositions), h = p();
                ...
                for (e = b; h >= e; e++) {
                    ...
                    if (void 0 != k) {
                        ...
                        i = !f.keepStatic && (void 0 != l[e + 1] && v(e + 1, l[e].locator.slice(), e).length > 1 || l[e] && void 0 != l[e].alternation) ? e + 1 : D(e), j = u(i, k.match.def) ? j && A(i, k.input, !0, !0) !== !1 : null == k.match.fn
                    }
                    if (!j)break
                }
        ...
        function r(a, b) {
            var c, d = a;
            for (void 0 != n().validPositions[a] && n().validPositions[a].input == f.radixPoint && (b++, d++), c = d; b > c; c++)void 0 == n().validPositions[c] || n().validPositions[c].input == f.radixPoint && c != p() || delete n().validPositions[c];
            for (c = b; c <= p();) {
                var e = n().validPositions[c], g = n().validPositions[d];
                void 0 != e && void 0 == g ? (u(d, e.match.def) && A(d, e.input, !0) !== !1 && (delete n().validPositions[c], c++), d++) : c++
            }
            var h = p();
            h >= a && void 0 != n().validPositions[h] && n().validPositions[h].input == f.radixPoint && delete n().validPositions[h], o(!0)
        }

        function s(b, c, d) {
            function e(b, c, d) {
                for (var e = f.greedy ? d : d.slice(0, 1), g = !1, h = b.locator[c].toString().split(","), i = 0; i < h.length; i++)if (-1 != a.inArray(h[i], e)) {
                    g = !0;
                    break
                }
                return g
            ...
            for (var g, h = v(b, c, d), i = p(), j = n().validPositions[i] || v(0)[0], k = void 0 != j.alternation ? j.locator[j.alternation].split(",") : [], l = 0; l < h.length && (g = h[l], !(f.greedy || g.match && (g.match.optionality === !1 || g.match.newBlockMarker === !1) && g.match.optionalQuantifier !== !0 && (void 0 == j.alternation || void 0 != g.locator[j.alternation] && e(g, j.alternation, k)))); l++);
            return g
        }

        function t(a) {
            return n().validPositions[a] ? n().validPositions[a].match : v(a)[0].match
        }
        ...
        function v(b, c, d) {
            function e(c, d, g, i) {
                function l(g, i, o) {
                    if (h > 1e4)return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + n().mask), !0;
                    if (h == b && void 0 == g.matches)return j.push({match: g, locator: i.reverse()}), !0;
                    if (void 0 != g.matches) {
                        if (g.isGroup && o !== !0) {
                            ...
                            var p = g;
                            if (g = e(g, d, i, o)) {
                                var q = j[j.length - 1].match, r = 0 == a.inArray(q, p.matches);
                                r && (k = !0), h = b
                            }
                        } else if (g.isAlternator) {
                            var s, t = g, u = [], v = j.slice(), w = i.length, x = d.length > 0 ? d.shift() : -1;
                            if (-1 == x || "string" == typeof x) {
                                var y, z = h, A = d.slice();
                                "string" == typeof x && (y = x.split(","));
                                for (var B = 0; B < t.matches.length; B++) {
                                    j = [], g = l(t.matches[B], [B].concat(i), o) || g, s = j.slice(), h = z, j = [];
                            ...
                            for (var I = d.length > 0 && o !== !0 ? d.shift() : 0; I < (isNaN(H.quantifier.max) ? I + 1 : H.quantifier.max) && b >= h; I++) {
            ...
            var g = n().maskToken, h = c ? d : 0, i = c || [0], j = [], k = !1;
            if (void 0 == c) {
                for (var l, m = b - 1; void 0 == (l = n().validPositions[m]) && m > -1;)m--;
                if (void 0 != l && m > -1)h = m, i = l.locator.slice(); else {
            ...
            }), n().tests[b] = a.extend(!0, [], j), n().tests[b]
        }
        ...
        function y(a, b) {
            var c = x().slice();
            if (a === !0)o(), a = 0, b = c.length; else for (var d = a; b > d; d++)delete n().validPositions[d], delete n().tests[d];
            for (var d = a; b > d; d++)c[d] != f.skipOptionalPartCharacter && A(d, c[d], !0, !0)
        }
        ...
        function A(b, c, d, e) {
            function g(b, c, d, e) {
                ...
                return a.each(v(b), function (h, i) {
                    for (var j = i.match, k = c ? 1 : 0, l = "", m = (x(), j.cardinality); m > k; m--)l += F(b - (m - 1));
                    if (c && (l += c), g = null != j.fn ? j.fn.test(l, n(), b, d, f) : c != j.def && c != f.skipOptionalPartCharacter || "" == j.def ? !1 : {
                            c: j.def,
                            pos: b
                        }, g !== !1) {
                        ...
                        return 1 != g && void 0 == g.pos && void 0 == g.c ? !1 : (h > 0 && o(!0), q(t, a.extend({}, i, {input: z(s, j)}), e) || (g = !1), !1)
                    }
                }), g
            }

            function h(b, c, d, e) {
                var g, h, i = a.extend(!0, {}, n().validPositions);
                for (g = p(); g >= 0; g--)if (n().validPositions[g] && void 0 != n().validPositions[g].alternation) {
                    h = n().validPositions[g].alternation;
                    break
                }
                if (void 0 != h)for (var j in n().validPositions)if (parseInt(j) > parseInt(g) && void 0 === n().validPositions[j].alternation) {
                    for (var k = n().validPositions[j], l = k.locator[h], m = n().validPositions[g].locator[h].split(","), q = 0; q < m.length; q++)if (l < m[q]) {
                        for (var r, s, t = j - 1; t >= 0; t--)if (r = n().validPositions[t], void 0 != r) {
                            s = r.locator[h], r.locator[h] = m[q];
                            break
                        }
                        if (l != r.locator[h]) {
                            for (var u = x().slice(), v = j; v < p() + 1; v++)delete n().validPositions[v], delete n().tests[v];
                            o(!0), f.keepStatic = !f.keepStatic;
                            for (var v = j; v < u.length; v++)u[v] != f.skipOptionalPartCharacter && A(p() + 1, u[v], !1, !0);
                            r.locator[h] = s;
                            var w = A(b, c, d, e);
            ...
            function i(b, c) {
                for (var d = n().validPositions[c], e = d.locator, f = e.length, g = b; c > g; g++)if (!B(g)) {
                    var h, i = v(g), j = -1;
                    for (var k in i)for (var l = i[k], m = 0; f > m; m++)e[m] == l.locator[m] && m > j && (j = m, h = l);
                    q(g, a.extend({}, h, {input: h.match.def}), !0)
                }
            }

            d = d === !0;
            for (var j = x(), k = b - 1; k > -1 && (!n().validPositions[k] || null != n().validPositions[k].match.fn); k--)void 0 == n().validPositions[k] && (!B(k) || j[k] != H(k)) && v(k).length > 1 && g(k, j[k], !0);
            var l = b, m = !1;
            if (e && l >= C() && o(!0), l < C() && (m = g(l, c, d, e), !d && m === !1)) {
                var s = n().validPositions[l];
                if (!s || null != s.match.fn || s.match.def != c && c != f.skipOptionalPartCharacter) {
                    if ((f.insertMode || void 0 == n().validPositions[D(l)]) && !B(l))for (var t = l + 1, u = D(l); u >= t; t++)if (m = g(t, c, d, e), m !== !1) {
                        i(l, t), l = t;
                        break
                    }
                } else m = {caret: D(l)}
            }
            return m === !1 && f.keepStatic && P(j) && (m = h(b, c, d, e)), m === !0 && (m = {pos: l}), m
        }
        ...
        function C() {
            var a;
            if (db = cb.prop("maxLength"), -1 == db && (db = void 0), 0 == f.greedy) {
                var b, c = p(), d = n().validPositions[c], e = void 0 != d ? d.locator.slice() : void 0;
                for (b = c + 1; void 0 == d || null != d.match.fn || null == d.match.fn && "" != d.match.def; b++)d = s(b, e, b - 1), e = d.locator.slice();
                a = b
            } else a = x().length;
        ...
        function D(a) {
            var b = C();
            if (a >= b)return b;
            for (var c = a; ++c < b && !B(c) && (f.nojumps !== !0 || f.nojumpsThreshold > c););
            return c
        }
        ...
        function F(a) {
            return void 0 == n().validPositions[a] ? H(a) : n().validPositions[a].input
        }
        ...
        function I(b, c, d, e) {
            ...
            o(), c && b._valueSet("");
            var h = w().slice(0, D(-1)).join(""), i = g.join("").match(new RegExp(J(h), "g"));
            if (i && i.length > 1 && g.splice(0, h.length), a.each(g, function (c, e) {
                    var f = p();
                    -1 == a.inArray(e, w().slice(f + 1, n().p)) || d ? (W.call(b, void 0, !0, e.charCodeAt(0), !1, d, d ? c : n().p), d = d || c > 0 && c > n().p) : W.call(b, void 0, !0, e.charCodeAt(0), !1, !0, f + 1)
                }), c) {
        ...
        function K(b) {
            if (b.data("_inputmask") && !b.hasClass("hasDatepicker")) {
                ...
                var g = (eb ? c.reverse() : c).join(""), h = (eb ? x().slice().reverse() : x()).join("");
        ...
        function M(b, c, d) {
            ...
            if ("number" != typeof c) {
                ...
                return !a(g).is(":visible") && h && void 0 != h.caret ? (c = h.caret.begin, d = h.caret.end) : g.setSelectionRange ? (c = g.selectionStart, d = g.selectionEnd) : document.selection && document.selection.createRange && (e = document.selection.createRange(), c = 0 - e.duplicate().moveStart("character", -1e5), d = c + e.text.length), c = L(c), d = L(d), {
                    begin: c,
                    end: d
                }
            }
        ...
        function N(b) {
            var c, d, e = x(), f = e.length, g = p(), h = {}, i = n().validPositions[g], j = void 0 != i ? i.locator.slice() : void 0;
            ...
            for (c = f - 1; c > g && (d = h[c].match, (d.optionality || d.optionalQuantifier || i && void 0 != i.alternation && void 0 != h[c].locator[i.alternation] && -1 != a.inArray(h[c].locator[i.alternation].toString(), k)) && e[c] == H(c, d)); c--)f--;
            return b ? {l: f, def: h[f] ? h[f].match : void 0} : f
        }

        function O(b) {
            var c = x(), d = c.slice();
            if (a.isFunction(f.postProcessOnBlur))f.postProcessOnBlur.call(b, d, f); else {
        ...
        function S(b) {
            ...
            function d() {
                ...
                return c ? c.opts.autoUnmask ? b.inputmask("unmaskedvalue") : h.call(this) != w().join("") ? h.call(this) : "" : h.call(this)
            }
            ...
            function g(b) {
                a(b).bind("mouseenter.inputmask", function () {
                    ...
                    "" != d && d != x().join("") && (i.call(this, a.isFunction(f.onBeforeMask) ? f.onBeforeMask.call(nb, d, f) || d : d), b.trigger("setvalue"))
            ...
            if (!b._valueGet) {
                ...
                document.__lookupGetter__ && b.__lookupGetter__("value") ? (h = b.__lookupGetter__("value"), i = b.__lookupSetter__("value"), b.__defineGetter__("value", d), b.__defineSetter__("value", e)) : (h = function () {
                    ...
                    b.value = a
                }, c(b.type), g(b)), b._valueGet = function () {
                    return eb ? h.call(this).split("").reverse().join("") : h.call(this)
        ...
        function T(b, c, d) {
            function e() {
                if (f.keepStatic) {
                    o(!0);
                    var a, c = [];
                    for (a = p(); a >= 0; a--)if (n().validPositions[a]) {
                        if (void 0 != n().validPositions[a].alternation)break;
                        c.push(n().validPositions[a].input), delete n().validPositions[a]
                    }
                    if (a > 0)for (; c.length > 0;)n().p = D(p()), W.call(b, void 0, !0, c.pop().charCodeAt(0), !1, !1, n().p)
                }
            }
            ...
            c == a.inputmask.keyCode.BACKSPACE && d.end - d.begin <= 1 ? d.begin = E(d.begin) : c == a.inputmask.keyCode.DELETE && d.begin == d.end && d.end++, r(d.begin, d.end), e();
            var h = p(d.begin);
        ...
        function U(a, b, c) {
            if (b && b.refreshFromBuffer) {
                ...
                y(d === !0 ? d : d.start, d.end), o(!0), void 0 != c && (G(a, x()), M(a, b.caret || c.begin, b.caret || c.end))
            }
        }

        function V(c) {
            fb = !1;
            var d = this, e = a(d), g = c.keyCode, i = M(d);
            g == a.inputmask.keyCode.BACKSPACE || g == a.inputmask.keyCode.DELETE || h && 127 == g || c.ctrlKey && 88 == g && !b("cut") ? (c.preventDefault(), 88 == g && (bb = x().join("")), T(d, g, i), G(d, x(), n().p), d._valueGet() == w().join("") && e.trigger("cleared"), f.showTooltip && e.prop("title", n().mask)) : g == a.inputmask.keyCode.END || g == a.inputmask.keyCode.PAGE_DOWN ? setTimeout(function () {
                var a = D(p());
                f.insertMode || a != C() || c.shiftKey || a--, M(d, c.shiftKey ? i.begin : a, a)
            }, 0) : g == a.inputmask.keyCode.HOME && !c.shiftKey || g == a.inputmask.keyCode.PAGE_UP ? M(d, 0, c.shiftKey ? i.begin : 0) : g == a.inputmask.keyCode.ESCAPE || 90 == g && c.ctrlKey ? (I(d, !0, !1, bb.split("")), e.click()) : g != a.inputmask.keyCode.INSERT || c.shiftKey || c.ctrlKey ? 0 != f.insertMode || c.shiftKey || (g == a.inputmask.keyCode.RIGHT ? setTimeout(function () {
                var a = M(d);
                M(d, a.begin)
            }, 0) : g == a.inputmask.keyCode.LEFT && setTimeout(function () {
                var a = M(d);
                M(d, eb ? a.begin + 1 : a.begin - 1)
            }, 0)) : (f.insertMode = !f.insertMode, M(d, f.insertMode || i.begin != C() ? i.begin : i.begin - 1));
            var j = M(d), k = f.onKeyDown.call(this, c, x(), j.begin, f);
        ...
        function W(b, c, d, e, g, h) {
            ...
            if (d) {
                ...
                var k, l = c ? {begin: h, end: h} : M(i), m = String.fromCharCode(d), p = Q(l.begin, l.end);
                p && (n().undoPositions = a.extend(!0, {}, n().validPositions), T(i, a.inputmask.keyCode.DELETE, l), f.insertMode || (f.insertMode = !f.insertMode, q(l.begin, g), f.insertMode = !f.insertMode), p = !f.multi), n().writeOutBuffer = !0;
                var r = eb && !p ? l.end : l.begin, s = A(r, m, g);
                if (s !== !1) {
                    if (s !== !0 && (r = void 0 != s.pos ? s.pos : r, m = void 0 != s.c ? s.c : m), o(!0), void 0 != s.caret)k = s.caret; else {
                        var t = n().validPositions;
                        k = !f.keepStatic && (void 0 != t[r + 1] && v(r + 1, t[r].locator.slice(), r).length > 1 || void 0 != t[r].alternation) ? r + 1 : D(r)
                    }
                    n().p = k
                }
                if (e !== !1) {
                    ...
                    if (setTimeout(function () {
                        ...
                        }, 0), n().writeOutBuffer && s !== !1) {
                        var w = x();
                        G(i, w, c ? void 0 : f.numericInput ? E(k) : k), c !== !0 && setTimeout(function () {
                            P(w) === !0 && j.trigger("complete"), gb = !0, j.trigger("input")
                        }, 0)
                    } else p && (n().buffer = void 0, n().validPositions = n().undoPositions)
                } else p && (n().buffer = void 0, n().validPositions = n().undoPositions);
                if (f.showTooltip && j.prop("title", n().mask), b && 1 != c) {
                    b.preventDefault();
                    var y = M(i), z = f.onKeyPress.call(this, b, x(), y.begin, f);
                    U(i, z, y)
                }
            }
        }
        ...
        function X(b) {
            var c = a(this), d = this, e = b.keyCode, g = x(), h = M(d), i = f.onKeyUp.call(this, b, g, h.begin, f);
            U(d, i, h), e == a.inputmask.keyCode.TAB && f.showMaskOnFocus && (c.is(":focus") && 0 == d._valueGet().length ? (o(), g = x(), G(d, g), M(d, 0), bb = x().join("")) : (G(d, g), M(d, L(0), L(C()))))
        }

        function Y(b) {
            if (gb === !0 && "input" == b.type)return gb = !1, !0;
            var c = this, d = a(c), e = c._valueGet(), g = M(c);
            ...
            var h = a.isFunction(f.onBeforePaste) ? f.onBeforePaste.call(c, e, f) || e : e;
            return I(c, !0, !1, eb ? h.split("").reverse() : h.split("")), d.click(), P(x()) === !0 && d.trigger("complete"), !1
        }

        function Z(b) {
            if (gb === !0 && "input" == b.type)return gb = !1, !0;
            var c = this, d = M(c), e = c._valueGet();
            e = e.replace(new RegExp("(" + J(w().join("")) + ")*"), ""), d.begin > e.length && (M(c, e.length), d = M(c)), x().length - e.length != 1 || e.charAt(d.begin) == x()[d.begin] || e.charAt(d.begin + 1) == x()[d.begin] || B(d.begin) || (b.keyCode = a.inputmask.keyCode.BACKSPACE, V.call(c, b)), b.preventDefault()
        }
        ...
        function $(b) {
            ...
            I(c, !1, !1);
            var d = n().p;
            G(c, x(), f.numericInput ? E(d) : d), P(x()) === !0 && a(c).trigger("complete"), b.preventDefault()
        }
        ...
        function _(b) {
            ...
            return setTimeout(function () {
                ...
                d.which = b.originalEvent.data.charCodeAt(0), fb = !1, hb = !1, W.call(c, d, void 0, void 0, !1);
                var e = n().p;
        ...
        function ab(b) {
            if (cb = a(b), cb.is(":input") && c(cb.attr("type"))) {
                if (cb.data("_inputmask", {
                        ...
                        opts: f,
                        isRTL: !1
                    }), f.showTooltip && cb.prop("title", n().mask), ("rtl" == b.dir || f.rightAlign) && cb.css("text-align", "right"), "rtl" == b.dir || f.numericInput) {
                ...
                cb.unbind(".inputmask"), cb.closest("form").bind("submit", function () {
                    bb != x().join("") && cb.change(), cb[0]._valueGet && cb[0]._valueGet() == w().join("") && cb[0]._valueSet(""), f.removeMaskOnSubmit && cb.inputmask("remove")
                }).bind("reset", function () {
                    setTimeout(function () {
                        cb.trigger("setvalue")
                    }, 0)
                    ...
                    var b = a(this), c = this;
                    !b.is(":focus") && f.showMaskOnHover && c._valueGet() != x().join("") && G(c, x())
                }).bind("blur.inputmask", function () {
                    var b = a(this), c = this;
                    if (b.data("_inputmask")) {
                        var d = c._valueGet(), e = x();
                        ib = !0, bb != x().join("") && (b.change(), bb = x().join("")), f.clearMaskOnLostFocus && "" != d && (d == w().join("") ? c._valueSet("") : O(c)), P(e) === !1 && (b.trigger("incomplete"), f.clearIncomplete && (o(), f.clearMaskOnLostFocus ? c._valueSet("") : (e = w().slice(), G(c, e))))
                    }
                }).bind("focus.inputmask", function () {
                    var b = a(this), c = this, d = c._valueGet();
                    f.showMaskOnFocus && !b.is(":focus") && (!f.showMaskOnHover || f.showMaskOnHover && "" == d) && c._valueGet() != x().join("") && G(c, x(), D(p())), bb = x().join("")
                }).bind("mouseleave.inputmask", function () {
                    var b = a(this), c = this;
                    f.clearMaskOnLostFocus && (b.is(":focus") || c._valueGet() == b.attr("placeholder") || (c._valueGet() == w().join("") || "" == c._valueGet() ? c._valueSet("") : O(c)))
                }).bind("click.inputmask", function () {
                    var b = a(this), c = this;
                    if (b.is(":focus")) {
                        var d = M(c);
                        if (d.begin == d.end)if (f.radixFocus && "" != f.radixPoint && -1 != a.inArray(f.radixPoint, x()) && (ib || x().join("") == w().join("")))M(c, a.inArray(f.radixPoint, x())), ib = !1; else {
                            var e = eb ? L(d.begin) : d.begin, g = D(p(e));
                ...
                P(x()) === !1 && f.clearIncomplete && o(), f.clearMaskOnLostFocus ? x().join("") == w().join("") ? b._valueSet("") : O(b) : G(b, x()), h === b && M(b, D(p())), R(b)
            }
        }

        var bb, cb, db, eb = !1, fb = !1, gb = !1, hb = !1, ib = !0;
        if (void 0 != d)switch (d.action) {
            case"isComplete":
                return cb = a(d.el), e = cb.data("_inputmask").maskset, f = cb.data("_inputmask").opts, P(d.buffer);
            case"unmaskedvalue":
                return cb = d.$input, e = cb.data("_inputmask").maskset, f = cb.data("_inputmask").opts, eb = d.$input.data("_inputmask").isRTL, K(d.$input);
            case"mask":
                bb = x().join(""), ab(d.el);
                break;
            case"format":
                ...
                return I(cb, !1, !1, eb ? jb.reverse() : jb), f.onKeyPress.call(this, void 0, x(), 0, f), d.metadata ? {
                    value: eb ? x().slice().reverse().join("") : x().join(""),
                    metadata: cb.inputmask("getmetadata")
                } : eb ? x().slice().reverse().join("") : x().join("");
            case"isValid":
                cb = a({}), cb.data("_inputmask", {
                    maskset: e,
                    opts: f,
                ...
                for (var kb = x(), lb = N(), mb = kb.length - 1; mb > lb && !B(mb); mb--);
                return kb.splice(lb, mb + 1 - lb), P(kb) && d.value == kb.join("");
            case"getemptymask":
                return cb = a(d.el), e = cb.data("_inputmask").maskset, f = cb.data("_inputmask").opts, w();
            case"remove":
                var nb = d.el;
                cb = a(nb), e = cb.data("_inputmask").maskset, f = cb.data("_inputmask").opts, nb._valueSet(K(cb)), cb.unbind(".inputmask"), cb.removeData("_inputmask");
                var ob;
            ...
            case"getmetadata":
                if (cb = a(d.el), e = cb.data("_inputmask").maskset, f = cb.data("_inputmask").opts, a.isArray(e.metadata)) {
                    for (var qb, rb = p(), sb = rb; sb >= 0; sb--)if (n().validPositions[sb] && void 0 != n().validPositions[sb].alternation) {
                        qb = n().validPositions[sb].alternation;
                        break
                    }
                    return void 0 != qb ? e.metadata[n().validPositions[rb].locator[qb]] : e.metadata[0]
                }
                return e.metadata
        }
    }
        ...
        numeric: {
            ...
            postFormat: function (b, c, d, e) {
                ...
                if (i.length > 0 && e.autoGroup || d && -1 != i.indexOf(e.groupSeparator)) {
                    ...
                    if (i = "" == e.radixPoint ? i : k[0], i != e.prefix + "?0" && i.length >= e.groupSize + e.prefix.length) {
                        f = !0;
            ...
            postProcessOnBlur: function (a, b) {
                var c = "" != b.radixPoint ? a.join("").split(b.radixPoint) : [a.join("")], d = c[0].match(b.regex.integerPart(b)), e = 2 == c.length ? c[1].match(b.regex.integerNPart(b)) : void 0;
                d && "-0" == d[d.index] && (void 0 == e || e[e.index].match(/^0+$/)) && a.splice(0, 1)
            },
            regex: {
            ...
            signHandler: function (a, b, c, d, e) {
                if (!d && (e.allowMinus && "-" === a || e.allowPlus && "+" === a)) {
                    ...
                    if (f && f[f.index].length > 0 && ("0" !== f[f.index] || b.buffer && b._buffer && b.buffer.join("") != b._buffer.join("")))return b.buffer[f.index] == ("-" === a ? "+" : "-") ? {
                        pos: f.index,
                        c: a,
                        remove: f.index,
                        caret: c
                    } : b.buffer[f.index] == ("-" === a ? "-" : "+") ? {remove: f.index, caret: c - 1} : {
                        pos: f.index,
                        c: a,
                        caret: c + 1
                    }
            ...
            leadingZeroHandler: function (b, c, d, e, f) {
                ...
                if (g && !e && (-1 == h || g.index < h))if ("0" == g[0] && d >= f.prefix.length) {
                    ...
                    if (void 0 == c.validPositions[h])return c.buffer[d] = b, {refreshFromBuffer: !0}
