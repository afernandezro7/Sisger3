...
class MenajeEditType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Belraysa\BackendBundle\Entity\Menaje'
        ));
    }
    ...
    {
        return 'belraysa_backendbundle_menaje_edit';
    }
}
