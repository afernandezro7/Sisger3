 ...
 * @ORM\Entity(repositoryClass="Belraysa\BackendBundle\Repository\AjusteRepository")
 * @ORM\Table()
 */
class Ajuste
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Belraysa\BackendBundle\Entity\BankingEntry", inversedBy="ajuste")
     * @ORM\JoinColumn(name="entrada", referencedColumnName="id")
     **/
    private $entrada;

    /**
     * @ORM\ManyToOne(targetEntity="Belraysa\BackendBundle\Entity\Banking", inversedBy="ajustes")
